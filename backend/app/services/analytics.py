...
POSITION_METRICS: dict[str, tuple[MetricDefinition, ...]] = {
    "Attack": (
        ...
        MetricDefinition("last5_goals_per90", "Goals /90 (last 5)"),
        MetricDefinition("assists_per90", "Assists /90"),
        MetricDefinition("last5_assists_per90", "Assists /90 (last 5)"),
    ...
    "Midfield": (
        MetricDefinition("assists_per90", "Assists /90"),
        MetricDefinition("last5_assists_per90", "Assists /90 (last 5)"),
        MetricDefinition("progressive_passes_per90", "Progressive passes /90"),
        MetricDefinition("goal_contributions_per90", "G+A /90"),
        MetricDefinition("goals_per90", "Goals /90"),
        MetricDefinition("minutes_played", "Minutes"),
    ),
    "Defender": (
        MetricDefinition("defensive_actions_per90", "Defensive actions /90"),
        MetricDefinition("minutes_played", "Minutes"),
        MetricDefinition("avg_minutes_per_match", "Avg min / match"),
